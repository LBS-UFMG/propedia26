...
The database is equipped with a user-friendly web interface and powerful search tools, allowing users to query complexes by PDB ID, peptide sequence, protein sequence, specific interaction motifs, or thermodynamic parameters. Furthermore, Propedia integrates advanced analytical capabilities, such as multiple sequence alignment and clustering based on peptide similarity, enabling comparative studies and the identification of binding patterns.<br><br>
Key Highlights:<br><br>
Curated Dataset: A comprehensive collection of protein-peptide complexes from the PDB, carefully validated and annotated.<br><br>
Dual Search Modes: Supports both text-based queries (e.g., PDB ID, UniProt ID) and sequence-based similarity searches (BLAST).
Advanced Filtering: Enables refinement of results by experimental method, resolution, interaction energy, and more.<br><br>
Integrated Analysis Tools: Built-in tools for visualizing interfaces, aligning sequences, and clustering complexes.<br><br>
Open Access: All data is freely available for download, supporting reproducible research.<br><br>
<h3 class="pt-4 pb-1"> What's new in version 26</h3>
Propedia 26 introduces major updates that significantly expand the database and enhance its analytical power.
<h3 class="pt-4 pb-1"> Expanded dataset</h3>
Increased complex count: The updated version of Propedia now includes 78,148 protein-peptide complexes, representing nearly a fourfold increase in data coverage compared to the previous release (19,813 complexes), an increase of approximately 3.9-fold, as shown in Figure 1.<br><br>
...
<img src="<?= base_url('img/docs/fig1.png') ?>" class="border mx-5 mt-4 mb-2 p-2 border-1 rounded w-75 shadow"><br><br>
...
Modernized layout: Complete visual overhaul with improved navigation and responsive design (Figure 2).<br><br>
Enhanced search page: More intuitive organization of search options and filters.<br><br>
...
<img src="<?= base_url('img/docs/fig2.png') ?>" class="border mx-5 mt-4 mb-2 p-2 border-1 rounded w-75 shadow"><br><br>
...
<img src="<?= base_url('img/docs/fig3.png') ?>" class="border mx-5 mt-4 mb-2 p-2 border-1 rounded w-75 shadow"><br><br>
...
·   	task blastp-short<br><br>
The task blastp-short parameter activates an optimized version of BLASTP specifically configured to handle short protein sequences, typically with fewer than 30 amino acids (Table C3: [blastp application options. The blastp...].”, 2021). This mode automatically adjusts various internal aspects of the algorithm to maximize sensitivity and detection of real similarity, even when the amount of information (sequence length) is very low.<br><br>
In implementing the sequence search system in PROPEDIA, -word_size 2 was used in conjunction with -task blastp-short. This choice is directly aligned with the expected behavior for searches involving short peptides, whose sequences have few positions for forming larger “words.”<br><br>
...
<img src="<?= base_url('img/docs/fig6.png') ?>" class="border mx-5 mt-4 mb-2 p-2 border-1 rounded w-75 shadow"><br><br>
