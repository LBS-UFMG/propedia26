    ...
    <div class="row">
        ...
        -->
            ...
            <ul class="bg-light p-3 rounded small">
                ...
                <li class="ms-4"><strong>ΔASA (complex) <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="ΔASA calculated by all complex"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[74] ?></span></li>
