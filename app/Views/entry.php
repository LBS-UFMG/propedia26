    ...
    <div class="row">
        ...
        -->
            ...
            <div class="row mt-5">
                ...
                <div class="col-12">
                    ...
                    <ul class="bg-light p-3 rounded small">
                        ...
                        <li class="ms-4"><strong>Similar peptide <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Similar peptide: Indicates a complex that has a peptide with the exact same sequence."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><a href=""><?= $info[84] ?></a></li>
            ...
            <ul class="bg-light p-3 rounded small">
                ...
                <li class="ms-4"><strong>ΔASA (peptide) <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="ΔASA (peptide): ΔASA_peptide represents the surface area that is no longer exposed to the solvent upon complex formation and is calculated by the equation: ΔASA = ASA_unbound - ASA_bound."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[73] ?></span></li>
                <li class="ms-4"><strong>ΔASA (complex) <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="ΔASA calculated by all interface (peptide and protein regions in contact)"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[74] ?></span></li>
                <li class="ms-4"><strong>BSA <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Buried Surface Area represents the area effectively shared at the binding interface and was calculated according to the expression. It can be calculated using the formula: BSA = (ASA_protein + ASA_peptide − ASA_complex) / 2"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[75] ?></span></li>
            </ul>
