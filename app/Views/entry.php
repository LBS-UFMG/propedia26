...
<div class="container-fluid px-4">
    <div class="row">
        ...
        # [70] Interface Residues	AAP	ABP	ACP	AIP	
        # [75] QSP	SBP	binding-cluster	interface-cluster	seq100_clusters	
        # [80] sequence-cluster	ASA_Complex	ASA_Protein	ASA_Peptide	BProA	
        $ [85] BPepA	BPP%	BSA
        -->
            ...
            <div class="row mt-5">
                ...
                <div class="col-12">
                    ...
                    <ul class="bg-light p-3 rounded small">
                        <li class="ms-4"><strong>Unique complex <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Unique complex: Indicates whether or not a protein-peptide pair exists with both sequences identical."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><label class="badge bg-<?php if ($info[16] == 'yes') { echo 'primary'; } else { echo 'danger'; } ?>"><?= $info[16] ?></span></li>
                        
                        <li class="ms-4"><strong>Similar complex <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Similar complex: If there is an identical sequence, it indicates which is the main entry with an exact sequence (if the sequence is unique, the entry itself will be considered the leader)."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><a href=""><?= $info[15] ?></a></li>

                        <li class="ms-4"><strong>Similar peptide <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Similar peptide: Indicates a complex that has a peptide with the exact same sequence."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><a href=""><?= $info[79] ?></a></li>

                        <li class="ms-4"><strong>PDB classification <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="PDB classification: Molecular classification according to PDB."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[4] ?></span></li>
                    </ul>
                    ...
                    <ul class="bg-light p-3 rounded small">
                        <li class="ms-4"><strong>Binding site <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Structures with similar binding site. For more details, see https://doi.org/10.1186/s12859-020-03881-z"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[77] ?></span></li>
                        <li class="ms-4"><strong>Interface <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Structures with similar interface. For more details, see https://doi.org/10.1186/s12859-020-03881-z"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[78] ?></span></li>
                        <li class="ms-4"><strong>Sequence <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Structures with sequences with high identity. For more details, see https://doi.org/10.1186/s12859-020-03881-z"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[80] ?></span></li>
                    </ul>
                </div>
            </div>
            <div class="row mt-4">
...
"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[54] ?></span></li>
                <li class="ms-4"><strong>Number of charged-charged contacts <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Number of Charged–Charged Contacts: Number of interactions between oppositely charged residues (e.g., Lys–Asp, Arg–Glu) across the binding interface, contributing significantly to electrostatic stabilization."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[55] ?></span></li>
                <li class="ms-4"><strong>Number of charged-polar contacts <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Number of Charged–Polar Contacts: Count of contacts between charged residues and polar uncharged residues (e.g., Lys–Ser, Asp–Thr), which often form hydrogen bonds or dipole interactions."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[56] ?></span></li>
                <li class="ms-4"><strong>Number of charged-apolar contacts <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Number of Charged–Apolar Contacts: Number of contacts between charged residues and hydrophobic residues (e.g., Arg–Leu, Lys–Val). These interactions typically contribute less to stability but may influence interface geometry."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[57] ?></span></li>
                <li class="ms-4"><strong>Number of polar-polar contacts <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Number of Polar–Polar Contacts: Number of interactions between polar uncharged residues (e.g., Ser–Thr, Asn–Gln), frequently involving hydrogen bonding or dipole alignment across the interface."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[58] ?></span></li>
                <li class="ms-4"><strong>Number of apolar-polar contacts <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Number of Apolar–Polar Contacts: Count of interactions between hydrophobic and polar residues at the interface, which can contribute to partial desolvation and interface packing."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[59] ?></span></li>
                <li class="ms-4"><strong>Number of apolar-apolar contacts <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Number of Apolar–Apolar Contacts: Number of hydrophobic–hydrophobic interactions (e.g., Leu–Val, Phe–Ile) that promote interface stabilization through the exclusion of water molecules (hydrophobic effect)."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[60] ?></span></li>
                <li class="ms-4"><strong>Percentage of apolar NIS residues <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Percentage of Apolar NIS Residues (%): Proportion of residues in the Non-Interacting Surface (NIS) that are classified as apolar, expressed as a percentage. This value helps assess the hydrophobic character of the exposed surface outside the binding interface."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[61] ?>%</span></li>
                <li class="ms-4"><strong>Percentage of charged NIS residues <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Percentage of Charged NIS Residues (%): Proportion of residues in the Non-Interacting Surface that are charged (either positively or negatively), expressed as a percentage. It reflects the electrostatic nature of the surface not involved in binding."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[62] ?>%</span></li>
                <li class="ms-4"><strong>Predicted binding affinity (kcal/mol) <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Predicted Binding Affinity (kcal·mol⁻¹): Estimated Gibbs free energy of binding (ΔG), in kilocalories per mole. More negative values indicate stronger predicted binding between the protein and peptide."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[63] ?></span></li>
                <li class="ms-4"><strong>Predicted dissociation constant (M) at 25.0˚C <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Predicted Dissociation Constant (M) at 25.0 °C: Predicted equilibrium dissociation constant (K_d), expressed in molar units (M), at 25 °C. It represents the expected concentration of the complex at which half of the binding sites are occupied. Lower values correspond to higher binding affinity."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[64] ?></span></li>
                <!-- 
                <li class="ms-4"><strong>Structure contains gaps <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Structure Contains Gaps: Indicates that missing residues or discontinuities are present in the protein or peptide chain, which may affect contact calculation or energy prediction."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[65] ?></span></li>
                <li class="ms-4"><strong>No contacts found for selection <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="No Contacts Found for Selection: Reported when no interatomic contacts are detected between the selected protein and peptide chains within the cutoff distance, implying a lack of direct interaction."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[66] ?></span></li>
                <li class="ms-4"><strong>PDB Column Misalignment <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="PDB Column Misalignment: Error indicating that the input PDB file has formatting inconsistencies (e.g., misplaced columns), preventing proper parsing of atomic coordinates."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[67] ?></span></li>
                <li class="ms-4"><strong>Unkown Aminoacid Found <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Unknown Amino Acid Found: Indicates that one or more residues contain undefined or nonstandard amino acid codes (e.g., “UNK”), which cannot be processed by the program."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[68] ?></span></li>
                <li class="ms-4"><strong>Invalid or missing coordinate <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Invalid or Missing Coordinate: Error message signaling that some atoms or residues lack valid three-dimensional coordinates, rendering them unusable for distance or contact calculations."><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= $info[69] ?></span></li>
            -->
            </ul>
