    ...
    <div class="row">
        ...
        -->
            ...
            <ul class="bg-light p-3 rounded small">
                ...
                <li class="ms-4"><strong>BPepA <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Buried peptide area"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= (int)$info[85] ?></span></li>
