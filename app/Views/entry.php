        ...
        <div class="col-md-8 col-12" ng-if="cttlok" id="col1">
            ...
            <div class="row mt-5">
                ...
                <div class="col-12">
                    ...
                    <ul class="bg-light p-3 rounded small">
                        <li class="ms-4"><strong>Binding site <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Structures with similar binding site. For more details, see https://doi.org/10.1186/s12859-020-03881-z"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= empty($info[40])?'-':$info[40] ?></span></li>
                        <li class="ms-4"><strong>Interface <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Structures with similar interface. For more details, see https://doi.org/10.1186/s12859-020-03881-z"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= empty($info[41])?'-':$info[41] ?></span></li>
                        <li class="ms-4"><strong>Sequence <a data-bs-toggle="popover" data-bs-title="Help" data-bs-trigger="hover focus" data-bs-content="Structures with sequences with high identity. For more details, see https://doi.org/10.1186/s12859-020-03881-z"><i class="bi bi-question-circle-fill opacity-25"></i></a>: </strong><span><?= empty($info[70])?'-':$info[70] ?></span></li>
                    </ul>
                </div>
            </div>
            <div class="row mt-4">
